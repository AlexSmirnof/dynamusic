            ...
            <dsp:droplet name="/atg/dynamo/droplet/ErrorMessageForEach">
              ...
              <table cellpadding="10">
                <tr>
                  ...
                  <td valign="middle">
                    <dsp:input bean="/dynamusic/ArtistFormHandler.value.name" 
                                        name="name" size="24" type="text"
                                        required="<%=true%>"/><br>
                  </td>
                </tr>
                <tr>
                  ...
                  <td valign="middle">                   
                      <dsp:input bean="/dynamusic/ArtistFormHandler.value.photoURL"
                                          name="photoURL" size="24" type="text"/><br>                      
                  </td>
                </tr>
                <tr>
                  <td valign="middle">
                  ...
                  <td valign="middle">
                      <dsp:textarea bean="/dynamusic/ArtistFormHandler.value.description"
                                               name="description" cols="60" rows="10"  wrap="SOFT"/>
                  </td>
                </tr>
                <tr>
                  <td> </td>
